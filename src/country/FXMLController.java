...
public class FXMLController implements Initializable {
  ...
  @FXML
  private TextField tfCountryAdjective;
  @FXML
  private TextField tfCountryCapitalState;
  @FXML
  ...
  private void btnExecuteClicked(ActionEvent event) {
    ...
    || tfCountryAdjective.getText().equals("")
    || tfCountryCapitalState.getText().equals("")
    || tfCountryCapitalProvince.getText().equals("")
    || tfCountryLeader.getText().equals("")) {
      lbMessage.setText("All fields have to be filled!");
    } else if(!tryParseInt(tfCountryCapitalState.getText()) 
      ...
      String adjective = tfCountryAdjective.getText();
      int capital = Integer.parseInt(tfCountryCapitalState.getText());
      ...
      Country country = new Country(project, template, tag, name, adjective, capital, capitalProvince, leader, color, culture);
